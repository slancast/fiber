...
#
source("/home/slancast/personalized-multiomic-clustering/Utils.r")
...
for (fiber_subset in c("Arabinoxylan","LCInulin","Mix")) {
  ...
  time_points = c("Baseline", "10", "20", "30", "WashoutD3", "WashoutD10","WashoutFinal")
}
...
load(paste("/home/slancast/personalized-multiomic-clustering/Full_",fiber_subset,"_clinical_df.RData",sep=""), envir = parent.frame())
  
load(paste("/home/slancast/personalized-multiomic-clustering/Normalized_Log_",fiber_subset,"_cytokine_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Normalized_Log_",fiber_subset,"_pcl_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Normalized_Log_",fiber_subset,"_rna_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Normalized_Log_",fiber_subset,"_metabolome_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Normalized_Log_",fiber_subset,"_genef_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Normalized_Log_",fiber_subset,"_lipids_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Normalized_Log_",fiber_subset,"_metaphlan_df.RData",sep=""), envir = parent.frame())

load(paste("/home/slancast/personalized-multiomic-clustering/Full_Log_",fiber_subset,"_cytokine_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Full_Log_",fiber_subset,"_pcl_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Full_Log_",fiber_subset,"_rna_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Full_Log_",fiber_subset,"_metabolomics_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Full_Log_",fiber_subset,"_genef_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Full_Log_",fiber_subset,"_lipids_df.RData",sep=""), envir = parent.frame())
load(paste("/home/slancast/personalized-multiomic-clustering/Full_Log_",fiber_subset,"_metaphlan_df.RData",sep=""), envir = parent.frame())
...
lipids_df2 <- lipids_df2[match(time_points, lipids_df2$timepoint),]
...
#genef_df2[3:nrow(genef_df2),], 

print("combined")
combined_df <- rbind(clinical_df2[3:nrow(clinical_df2),], cytokine_df2[3:nrow(cytokine_df2),], metaphlan_df2[3:nrow(metaphlan_df2),], pcl_df2[3:nrow(pcl_df2),], rna_df2[3:nrow(rna_df2),], metabolomics_df2[3:nrow(metabolomics_df2),])
combined_df <- as.matrix(combined_df) #If one wants run this on the non-imputed values simply comment out this line
...
m <- exprs(eset) 
m <- na.omit(m) #standardize introduces NAs into the matrix if there is no variation in that analyte
...
library(icesTAF)
mkdir(paste("/home/slancast/personalized-multiomic-clustering/",participant,fiber_subset,sep=""))

pdf(paste("/home/slancast/personalized-multiomic-clustering/",participant,fiber_subset,"/clusters",z,"personalized_",fiber_subset,"_parcoord2.pdf",sep=""))
...
write.table(cluster_membership, file = paste("/home/slancast/personalized-multiomic-clustering/",participant,fiber_subset,"/clusters",z,"personalized_",fiber_subset,"_cluster_membership.txt",sep=""), sep="\t")
...
#   write.table(get(paste("cluster",as.character(i),sep="")), file = paste("/home/slancast/personalized-multiomic-clustering/",participant,fiber_subset,"/clusters",z,"cluster",as.character(i),"_",fiber_subset,".txt",sep=""),sep="\t")
...
#   getFunctionalAnnotationChartFile(david, fileName = paste("/home/slancast/personalized-multiomic-clustering/",participant,fiber_subset,"/clusters",z,"cluster",as.character(i),"_",fiber_subset,"AnnotationChart.txt",sep=""))
#   getFunctionalAnnotationTableFile(david, fileName = paste("/home/slancast/personalized-multiomic-clustering/",participant,fiber_subset,"/clusters",z,"cluster",as.character(i),"_",fiber_subset,"AnnotationTable.txt",sep=""))
#   getClusterReportFile(david, fileName = paste("/home/slancast/personalized-multiomic-clustering/",participant,fiber_subset,"/clusters",z,"cluster",as.character(i),"_",fiber_subset,"ClusterReport.txt",sep=""))
# } } 
} #ending cluster loop
},
