...
volcanoplot <- function (res, lfcthresh=2, sigthresh=0.1, main="Volcano Plot", legendpos="bottomright", labelsig=FALSE, textcx=1, ...) {
...
dir <- "/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/rsem_genes_results_all_trimmed"
...
###
txi <- tximport(files1_2, type = "rsem")
names(txi)
...
for (i in colnames(sampleTable)[3]) {
  ...
  for (j in unique(sampleTable[[i]])) { 
    ...
    #[33:length(resultsNames(ddsDESeq))]
    for (h in resultsNames(ddsDESeq)){
      print(h)
      ...
      res.fixed <- fdrtool(res$stat, statistic = "normal", plot=FALSE) #adjusting for batch effects (https://support.bioconductor.org/p/99685/; http://www-huber.embl.de/users/klaus/Teaching/DESeq2Predoc2014.html)
      ...
      # png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results2/",h,"resLFC-maplot.png",sep=""), 1500, 1000, pointsize=20)
      ...
      ## Write results
      write.csv(resdata, file=paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results2/",h,"-diffexpr-resultsb.csv",sep=""))
      
      ###Visualization and data collection
      
      # Plot dispersions
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results2/",h,"qc-dispersions.png",sep=""), 1000, 1000, pointsize=20)
      ...
      # png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results2/",h,"qc-heatmap-samples.png",sep=""), w=1000, h=1000, pointsize=20)
      ...
      # png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results2/",h,"qc-pca.png",sep=""), 1000, 1000, pointsize=20)
      ...
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results2/",h,"res-pvalue.png",sep=""), 1000, 1000, pointsize=20)
      hist(res$pvalue, breaks=250, col="grey")
      dev.off()
      
      ## MA plot
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results2/",h,"diffexpr-maplot-noLFC.png",sep=""), 1500, 1000, pointsize=20)
      maplot(resdata, ylim = c(-1,1), main="MA Plot")
      dev.off()
      
      ## Volcano plot with "significant" genes labeled
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results2/",h,"diffexpr-volcanoplot.png",sep=""), 1200, 1000, pointsize=20)
