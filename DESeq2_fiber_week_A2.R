...
factor_level_number <- Sys.getenv(c("var"))
factor_level_number <- as.numeric(factor_level_number)
...
for (i in colnames(sampleTable)[3]) {
  ...
  for (j in unique(sampleTable[[i]][factor_level_number])) { 
    print(j)
    ...
    for (h in resultsNames(ddsDESeq)[2:length(resultsNames(ddsDESeq))]){
      print(h)
      ...
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results/",h,"resLFC-maplot.png",sep=""), 1500, 1000, pointsize=20)
      ...
      ## Write results
      write.csv(resdata, file=paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results/",h,"-diffexpr-results.csv",sep=""))
      
      ###Visualization and data collection
      
      # Plot dispersions
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results/",h,"qc-dispersions.png",sep=""), 1000, 1000, pointsize=20)
      ...
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results/",h,"qc-heatmap-samples.png",sep=""), w=1000, h=1000, pointsize=20)
      ...
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results/",h,"qc-pca.png",sep=""), 1000, 1000, pointsize=20)
      ...
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results/",h,"res-pvalue.png",sep=""), 1000, 1000, pointsize=20)
      hist(res$pvalue, breaks=250, col="grey")
      dev.off()
      
      ## MA plot
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results/",h,"diffexpr-maplot-noLFC.png",sep=""), 1500, 1000, pointsize=20)
      maplot(resdata, ylim = c(-1,1), main="MA Plot")
      dev.off()
      
      ## Volcano plot with "significant" genes labeled
      png(paste("/labs/mpsnyder/slancast/fiber/rnaseq/pre2019/RNAseq_results/",h,"diffexpr-volcanoplot.png",sep=""), 1200, 1000, pointsize=20)
