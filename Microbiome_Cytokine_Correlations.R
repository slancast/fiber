load("/Users/SLancaster/Desktop/Projects/Fiber/Multiomics/RData/Normalized_Log_Arabinoxylan_cytokine_df.RData")
...
matching_samples2 <- !is.na( match(tmp,rownames(cytokine_matching_df)))
...
pcl_matching_df <- pcl_matching_df[,1:132] #Keeping only the genera, and not pathways
...
pcl_matching_df <- pcl_matching_df[,2:132]
